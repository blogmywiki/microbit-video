...
int main() {           
    ...
    DrawString(5,10,"micro:bit BASIC");
    DrawString(5,20,"7167 bytes free");
    DrawString(5,50,"abcdefghihjklmn");
    DrawString(5,60,"opqrstuvwxyz!@$");
    DrawString(5,70,"ABCDEFGHIJKLMNO");
    DrawString(5,80,"PQRSTUVWXYZ[]{}");
